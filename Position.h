...
//matrice de taille 10*2 chaque ligne reprsente une direction
//remplisage automatique({ordonnee,abscisse} ;
...
public :
    ...
    int NbrOfFreeCases(const GameSpace& ech) ;  //calculer le nombre des cases vides qui entoure une position
    Position FindOptimalNeighborCase(const GameSpace&) ; //chercher la case optimale pour faire la meilleur movement
    //*********(2) les methodes necessaire pour l'algorithme de minimax **************
